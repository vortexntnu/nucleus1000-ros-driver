...
class UnsConnect:
    ...
    def set_tcp_hostname(self, tcp_hostname):
    ...
    def set_use_queues(self, use_queues):
    ...
    def connect_uns(self, serial_port=None, serial_baudrate=None, timeout=None, tcp_ip=None, tcp_hostname=None,
                    tcp_port=None, udp_port=None, blocking = False, ignore_connection_error=False):
    ...
    def serial_reset_buffer(self, buffer):
    ...
    def uns_read(self, size=None, terminator=None, timeout=None):
    ...
    def uns_readline(self, timeout=None):
